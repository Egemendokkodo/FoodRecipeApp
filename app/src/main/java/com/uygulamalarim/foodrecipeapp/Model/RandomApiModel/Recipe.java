...
public class Recipe {
    ...
    public void setAnalyzedInstructions(List<AnalyzedInstruction> value) {
    ...
    public void setHealthScore(long value) {
    ...
    public void setDiets(List<String> value) {
        this.diets = value;
    }
    ...
    public void setPreparationMinutes(long value) {
    ...
    public void setCookingMinutes(long value) {
        this.cookingMinutes = value;
    }
    ...
    public void setExtendedIngredients(List<ExtendedIngredient> value) {
    ...
    public void setDishTypes(List<String> value) {
    ...
    public void setCuisines(List<String> value) {
        this.cuisines = value;
    }
    ...
    public void setOccasions(List<Object> value) {
